...
<html lang="en" dir="ltr">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css?family=Fredericka+the+Great|Hanalei+Fill|Notable|Press+Start+2P" rel="stylesheet"> 
    ...
    <body id="bg4">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="http://exo-pdo/exo1/view/view5.php">Exercice 5</a>                    </li>
                    <li class="nav-item active">
        ...
        <div class="container-fluid">
            <div class="row">
                <!--Troisième exercice-->
                <div class="firstTest offset-2 col-4 text-center">
                    <h1>4- Affichage des clients possedants une carte de fidélité</h1>
                    ...
                    <table class="col-12 text-center">
                        ...
                        <tbody>
                            <?php foreach ($clientListCI as $clientDetail) { ?>
                                <tr>
