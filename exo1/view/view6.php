...
<html lang="en" dir="ltr">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css?family=Chicle|Fredoka+One" rel="stylesheet" />
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="firstTest offset-4 col-4 text-center">
                    <h1>6- Affichage des détails de tout les concerts</h1>
                    <!---->

                    <?php foreach ($show as $showDetail) { ?>
                        <ul>
                            <li> <?= $showDetail->title ?>par<?= $showDetail->performer ?>, le <?= $showDetail->date ?> <?= $showDetail->startTime ?></li>
                        </ul>
                    <?php } ?>
