...
<html lang="en" dir="ltr">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css?family=Hanalei+Fill|Notable" rel="stylesheet"> 
    ...
    <body id="bg1">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="http://exo-pdo/exo1/navBar/nav.php#">PDO</a>
        ...
        <div class="container-fluid">
            <div class="row">
                <!--Premier exercice-->
                <div class="firstTest col-4 text-center">
                    ...
                    <table class="col-12 text-center">
                        ...
                        <tbody>
                            <?php foreach ($clientAllL as $clientDetail) { ?>
                                <tr>
